  ...
  server.registerTool(
    "turath_search",
    {
      ...
      inputSchema: {
        ...
        category: z.number().optional().describe("Turath.io category ID"),
        author: z.number().optional().describe("Turath.io author ID"),
        book: z.number().optional().describe("Turath.io book ID"),
        page: z.number().optional().describe("Search results page number"),
      },
    },
