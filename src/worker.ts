...
function createServer() {
  ...
  server.registerTool(
    ...
    {
      description:
        "Conduct focused scholarly research using only Turath.io. Search Turath.io for the requested topic, retrieve relevant original Arabic page text, and return book, author, volume, and page information. Use this tool for research about classical Arabic and Islamic texts. Do not supplement missing information with general knowledge or external sources.",
      inputSchema: {
        query: z
          .string()
          .describe(
        ...
        max_results: z
          ...
          .optional()
          .describe(
            "Maximum number of source pages to retrieve. Default is 3 and maximum is 5."
          ),
      },
    },
    async ({
                ...
                text: JSON.stringify(
                  {
                    ...
                    instruction:
                      "Do not answer from general knowledge or external sources. State that the requested information was not found in Turath.io.",
                  },
                  null,
                  2
                ),
